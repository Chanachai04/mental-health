            ...
            <table className="min-w-full bg-white text-left text-sm">
              ...
              <tbody className="divide-y divide-gray-100">
                <tr className="hover:bg-gray-50 transition duration-200">
                  <td className="px-4 sm:px-6 py-4 text-gray-800">example_user</td>
                  <td className="px-4 sm:px-6 py-4 text-gray-800 break-words">“Living the dream”</td>
                ...
                <tr className="hover:bg-gray-50 transition duration-200">
                  <td className="px-4 sm:px-6 py-4 text-gray-800">another_user</td>
                  <td className="px-4 sm:px-6 py-4 text-gray-800 break-words">“Just vibing”</td>
